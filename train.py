...
def train(cfg, args):
    ...
    n_params = sum(p.numel() for name, p in model.named_parameters() if p.requires_grad)
    print(n_params)
    #
    # model = net
...
def main():
    ...
    parser.add_argument('--log_step', default=1000, type=int, help='Print logs every log_step')
